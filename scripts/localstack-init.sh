...
# Partners
awslocal dynamodb put-item --table-name lon12-table --item '{"PK":{"S":"PARTNERS"},"SK":{"S":"PARTNER#partner-001"},"entityType":{"S":"Partner"},"id":{"S":"partner-001"},"name":{"S":"Barclays Bank"},"type":{"S":"fi"},"reportsShared":{"N":"12"},"accessLevel":{"S":"download"}}'
awslocal dynamodb put-item --table-name lon12-table --item '{"PK":{"S":"PARTNERS"},"SK":{"S":"PARTNER#partner-002"},"entityType":{"S":"Partner"},"id":{"S":"partner-002"},"name":{"S":"HSBC"},"type":{"S":"fi"},"reportsShared":{"N":"8"},"accessLevel":{"S":"view"}}'
awslocal dynamodb put-item --table-name lon12-table --item '{"PK":{"S":"PARTNERS"},"SK":{"S":"PARTNER#partner-003"},"entityType":{"S":"Partner"},"id":{"S":"partner-003"},"name":{"S":"Anti-Slavery International"},"type":{"S":"ngo"},"reportsShared":{"N":"15"},"accessLevel":{"S":"download"}}'
awslocal dynamodb put-item --table-name lon12-table --item '{"PK":{"S":"PARTNERS"},"SK":{"S":"PARTNER#partner-004"},"entityType":{"S":"Partner"},"id":{"S":"partner-004"},"name":{"S":"Metropolitan Police"},"type":{"S":"le"},"reportsShared":{"N":"6"},"accessLevel":{"S":"download"}}'
awslocal dynamodb put-item --table-name lon12-table --item '{"PK":{"S":"PARTNERS"},"SK":{"S":"PARTNER#partner-005"},"entityType":{"S":"Partner"},"id":{"S":"partner-005"},"name":{"S":"Europol"},"type":{"S":"le"},"reportsShared":{"N":"4"},"accessLevel":{"S":"view"}}'
awslocal dynamodb put-item --table-name lon12-table --item '{"PK":{"S":"PARTNERS"},"SK":{"S":"PARTNER#partner-006"},"entityType":{"S":"Partner"},"id":{"S":"partner-006"},"name":{"S":"Standard Chartered"},"type":{"S":"fi"},"reportsShared":{"N":"10"},"accessLevel":{"S":"download"}}'
